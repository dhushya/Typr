...
const backgroundColors = ["#141414", '#8105d8', "#3b064d", "#fe59d7", "#595238", "#1dd3bd", "#fa26a0", "#383e56", "#fa1616"]
...
function addItem() {
    ...
    g.setAttribute("class", "score");
    g.setAttribute("id",id.toString());
    g.textContent = id.toString();
    g.setAttribute("style", "left: " + ((screen.width)/2 - 100).toString() + "px");
    id = id + 1;
    document.body.appendChild(g);
    var rem = document.getElementById((id - 1).toString());
    anime({
        targets: rem,
        opacity: 0,
        translateY: -30,
        duration: 2000
    }).finished.then(() => document.body.removeChild(rem));
    return;
}
